...
const moment = __nccwpck_require__(470);
...
const github = __nccwpck_require__(904);
...
const fetchReviews = __nccwpck_require__(486);
const calculateTimeDifference = __nccwpck_require__(950);
...
const getTimeToFirstReview = __nccwpck_require__(752);
const fetchPullRequests = __nccwpck_require__(574);
...
(() => {
const core = __nccwpck_require__(567);

const main = __nccwpck_require__(829);
